...
1. Buka Halaman [Repo](https://github.com/Harun1804/pengelolaan-laboratorium)
...
```
git clone https://github.com/UsernameGithubAnda/pengelolaan-laboratorium.git
```

4. Masuk Ke Dalam Folder Hasil Clone

```
cd pengelolaan-laboratorium
```
...
```
git remote add upstream https://github.com/Harun1804/pengelolaan-laboratorium.git
```
...
5. Buatlah database kosong di phpmyadmin dengan nama **db_pengelolaan_lab**
