                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('namaKegiatan') is-invalid @enderror" id="namaKegiatan" placeholder="Masukan Nama Kegiatan" wire:model="namaKegiatan" value="{{ old('namaKegiatan',$namaKegiatan) }}">
                                @error('namaKegiatan')
                        ...
                        <div class="col-md-12">
                            <div class="form-check">
                                ...
                                <br>
                                <div class="custom-control custom-radio">
                                    <input type="radio" id="kategori1" name="kategori" class="custom-control-input" value="maintenance" wire:model="kategori" @if ($kategori == "maintenance") checked @endif>
                                    <label class="custom-control-label" for="kategori1">Maintenance</label>
                                </div>
                                <div class="custom-control custom-radio">
                                    <input type="radio" id="kategori2" name="kategori" class="custom-control-input" value="monitoring dan evaluasi" wire:model="kategori" @if ($kategori == "monitoring dan evaluasi") checked @endif>
                                    <label class="custom-control-label" for="kategori2">Monitoring dan Evaluasi</label>
                                </div>
                                <div class="custom-control custom-radio">
                                    <input type="radio" id="kategori3" name="kategori" class="custom-control-input" value="penggunaan alat" wire:model="kategori" @if ($kategori == "penggunaan alat") checked @endif>
                                    <label class="custom-control-label" for="kategori3">Penggunaan Alat</label>
                                </div>
                                <div class="custom-control custom-radio">
                                    <input type="radio" id="kategori4" name="kategori" class="custom-control-input" value="pemeliharaan" wire:model="kategori" @if ($kategori == "pemeliharaan") checked @endif>
