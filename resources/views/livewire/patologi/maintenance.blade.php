                        ...
                        <form method="post" wire:submit.prevent="store">
                            ...
                            <div class="form-check">
                                ...
                                @foreach ($alat as $key => $value)
                                    @if ($value->kegiatan->kategori == $kategori && $value->periode == "harian" && $value->kelompok_kegiatan == "pre_on")
                            ...
                            <div class="form-check">
                                ...
                                <hr>
                                @foreach ($alat as $key => $value)
                                    @if ($value->kegiatan->kategori == $kategori && $value->periode == "harian" && $value->kelompok_kegiatan == "pre_off")
                                        <div class="custom-control custom-checkbox">
                            ...
                            <div class="form-check">
                                ...
                                <hr>
                                @foreach ($alat as $key => $value)
                                    @if ($value->kegiatan->kategori == $kategori && $value->periode == "harian" && $value->kelompok_kegiatan == "pre_run")
                                        <div class="custom-control custom-checkbox">
                                            <input type="checkbox" class="custom-control-input" id="customCheck{{ $key }}" wire:model="kegiatan_id.{{ $key }}" value="{{ $value->kegiatan_id }}" name="kegiatan_id.{{ $key }}">
                                            <label class="custom-control-label" for="customCheck{{ $key }}">{{ $value->kegiatan->nama_kegiatan }}</label>                                      
                                        </div>
                            ...
                            <div class="form-check">
                                ...
                                <hr>
                                @foreach ($alat as $key => $value)
                                    @if ($value->kegiatan->kategori == $kategori && $value->periode == "harian" && $value->kelompok_kegiatan == "post_run")
                                        <div class="custom-control custom-checkbox">
                                            <input type="checkbox" class="custom-control-input" id="customCheck{{ $key }}" wire:model="kegiatan_id.{{ $key }}" value="{{ $value->kegiatan_id }}" name="kegiatan_id.{{ $key }}">
                                            <label class="custom-control-label" for="customCheck{{ $key }}">{{ $value->kegiatan->nama_kegiatan }}</label>                                        
                                        </div>
                    ...
                    <div class="tab-pane fade" wire:ignore id="pills-mingguan-nobd" role="tabpanel"
                        ...
                        <form method="post" wire:submit.prevent="store">
                            ...
                            <div class="form-check">
                                ...
                                <hr>
                                @foreach ($alat as $key => $value)
                                    @if ($value->kegiatan->kategori == $kategori && $value->periode == "mingguan")
                                        <div class="custom-control custom-checkbox">
                                            <input type="checkbox" class="custom-control-input" id="customCheck{{ $key }}" wire:model="kegiatan_id.{{ $key }}" value="{{ $value->kegiatan_id }}" name="kegiatan_id.{{ $key }}">
                                            <label class="custom-control-label" for="customCheck{{ $key }}">{{ $value->kegiatan->nama_kegiatan }}</label>                                        
                                        </div>
                    ...
                    <div class="tab-pane fade" wire:ignore id="pills-bulanan-nobd" role="tabpanel"
                        ...
                        <form method="post" wire:submit.prevent="store">
                            ...
                            <div class="form-check">
                                ...
                                <hr>
                                @foreach ($alat as $key => $value)
                                    @if ($value->kegiatan->kategori == $kategori && $value->periode == "bulanan")
                                        <div class="custom-control custom-checkbox">
                                            <input type="checkbox" class="custom-control-input" id="customCheck{{ $key }}" wire:model="kegiatan_id.{{ $key }}" value="{{ $value->kegiatan_id }}" name="kegiatan_id.{{ $key }}">
                                            <label class="custom-control-label" for="customCheck{{ $key }}">{{ $value->kegiatan->nama_kegiatan }}</label>
                                        </div>
